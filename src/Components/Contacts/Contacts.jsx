					...
					<div className="filter">
						<div className="checkbox__row">
							<div className="checkbox-block">
								<label>
									<input className="checkbox" type="checkbox" id="male" onChange={handleCheckBoxChange} />
									<span className="custom-checkbox">Чол</span>
								</label>
							</div>
							<div className="checkbox-block">
								<label>
									<input className="checkbox" type="checkbox" id="female" onChange={handleCheckBoxChange} />
									<span className="custom-checkbox">Жін</span>
								</label>
							</div>
							<div className="checkbox-block">
								<label>
									<input className="checkbox" type="checkbox" id="agender" onChange={handleCheckBoxChange} />
									<span className="custom-checkbox">Не визначено</span>
								</label>
							</div>
						</div>
						<div className="search">
							<input type="text" placeholder="Пошук" onChange={handleSearchChange} value={search} />
						</div>
					</div>
				</div>
			</div>
